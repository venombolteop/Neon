...
SUDO_USERS_ID = list(map(int, os.environ.get("SUDO_USERS_ID", "5045429385").split()))
LOG_GROUP_ID = int(os.environ.get("LOG_GROUP_ID", "-1001674865910"))
GBAN_LOG_GROUP_ID = int(os.environ.get("GBAN_LOG_GROUP_ID","-1001609611579"))
MESSAGE_DUMP_CHAT = int(os.environ.get("MESSAGE_DUMP_CHAT", "-1001609611579" ))
...
ARQ_API_KEY = os.environ.get("ARQ_API_KEY","UENTQI-XCFHRE-XFNNBY-YQVXOD-ARQ")
